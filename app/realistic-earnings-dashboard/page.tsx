...
export default function RealisticEarningsDashboard() {
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    <Icon
                        className={`w-8 h-8 ${isNegative ? "text-red-500" : "text-green-500"
                            }`}
                    />
                    {typeof trend === "number" &&
                        (trend > 0 ? (
    ...
    const AlertCard: React.FC<AlertCardProps> = ({ message, type = "warning" }) => (
        <div
            className={`p-4 rounded-lg border-l-4 ${type === "danger"
        ...
        >
            <div className="flex items-center">
                <AlertTriangle
                    className={`w-5 h-5 mr-3 ${type === "danger" ? "text-red-500" : "text-yellow-500"
                        }`}
                />
                <p
                    className={`text-sm font-medium ${type === "danger" ? "text-red-800" : "text-yellow-800"
                        }`}
                >
                    {message}
                </p>
                        ...
                        <div key={key} className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span
                                        className={`font-semibold ${data.avgMonthlyReturn < 0
                                            ? "text-red-600"
                                            : "text-green-600"
                                            }`}
                                    >
