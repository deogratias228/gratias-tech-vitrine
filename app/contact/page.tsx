...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch("https://formspree.io/f/xvgwalry", {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    service: selectedService, // tu peux aussi envoyer le service sélectionné
                }),
            });
    ...
    return (
        <>
            <Head>
                <title>Contact - Gratias Technology</title>
                <meta
                    name="description"
                    content="Contactez Gratias Technology à Lomé pour vos projets de développement web, mobile et desktop."
                />
            </Head>
            ...
            <section className="bg-white py-16 md:py-24">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-2 gap-12">
                    ...
                    <div className="p-3 md:p-8 rounded-lg shadow border border-gray-200">
                        <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6">
                            ...
                            <div>
                                ...
                                // buttonStyle={{ backgroundColor: '#f0f0f0', border: 'none' }}
                                />
                            </div>
                            ...
                            <button
                                ...
                                className={`w-full py-2 md:py-3 px-6 rounded-md font-semibold text-white transition-colors duration-200 ${isSubmitting
                    ...
                    <div className="w-full col-span-2">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.7305879821306!2d1.2046512743574322!3d6.166821227206748!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1023e3ad0461ae1d%3A0x903f5230c27eb4a6!2sGratias%20Technology!5e0!3m2!1sfr!2stg!4v1758287403891!5m2!1sfr!2stg" className='min-h-96 w-full rounded-xl' loading="lazy"></iframe>                    </div>
                </div>
            </section>
        </>
    );
